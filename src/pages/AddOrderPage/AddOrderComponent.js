                ...
                <Form>
                    <FormGroup onSubmit={this.handlerSubmit}>
                        ...
                        <FormControl as="select" required
                                     onClick={this.handlerChangesMeal}>
                    ...
                    <FormGroup>
                        ...
                        <FormControl type="text" onChange={this.handlerChangesRestaurant} required
                                     placeholder="Restaurant Name" value={this.state.restaurantName}/>
                    </FormGroup>
                    <FormGroup>
                        <FormLabel>Friend's Name - Invite your friends </FormLabel>
                        <FormControl type="text" placeholder="Friend's Name" onChange={this.handlerChangesFriends}/>
                    </FormGroup>
                    <FormGroup>
                        <FormLabel>Group's Name - Invite your groups </FormLabel>
                        <FormControl type="text" placeholder="Groups's Name" onChange={this.handlerChangesGroups}/>
                    </FormGroup>
                    <FormGroup>
                        <FormLabel>Put Menu Image</FormLabel>
                        <FormControl type="text" value={this.state.menuImage}
